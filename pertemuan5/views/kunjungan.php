                ...
                <tbody>
                    ...
                    if(isset($_POST['type'])) {
                        if($_POST['type'] == "delete") {
                            ...
                            echo '<script>alert("Data berhasil dihapus")</script><meta http-equiv="refresh" content="0; url=?url=kunjungan">';
                        }
                        if ($_POST['type'] == "add") {
                            $data = [
                            ...
                            echo '<script>alert("Data berhasil ditambahkan")</script><meta http-equiv="refresh" content="0; url=?url=kunjungan">';
                        }
                        ...
                        if ($_POST['type'] == "update") {
                            ...
                            echo '<script>alert("Data berhasil diupdate")</script><meta http-equiv="refresh" content="0; url=?url=kunjungan">';
                        }
                    }
                    ?>
                </tbody>
